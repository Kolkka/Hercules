 ...
 *
 * Packets sent:
 * 0x3019 <len>.W <account id>.L <guild id>.L <capacity>.L <amount>.L {<item>.P}*<capacity>
 *
 * @param account_id The requesting account ID.
 * @param gstor      The guild storage to send.
 * @return Error code.
